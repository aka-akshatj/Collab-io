    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-black to-purple-900 text-white overflow-hidden">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 relative z-10">
        <div className="w-full max-w-md space-y-8 relative">
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-blue-500 rounded-lg filter blur-3xl opacity-20 "></div>
          ...
          <div className="absolute -top-20 -left-40 -z-10">
            <Atom className="h-40 w-40 text-blue-500 opacity-20 animate-bounce  " />
          </div>
          <div className="absolute -bottom-20 -right-44 -z-10">
